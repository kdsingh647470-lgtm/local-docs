      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-10 sm:py-14">
        ...
        <div className="mt-10 grid gap-10 lg:grid-cols-[220px_1fr]">
          ...
          <div className="space-y-6">
            ...
            <DocSection id="pdf-to-jpg" title="How PDF to Image works">
              <p>
                ...
                quality setting to keep files small. Rendering is capped to a fixed pixel budget so a phone produces the same image
            ...
            <DocSection id="jpg-to-pdf" title="How Image to PDF works">
              <p>
                Add as many JPG, PNG, WEBP, GIF, BMP or AVIF images as you like (anything other than JPG
                or PNG is re-encoded losslessly to PNG before embedding); each one becomes a single page in a new
              ...
              <p>
                <strong>A4</strong> and <strong>Letter</strong> place every image centred on a standard page
                with your chosen margin, switching to landscape automatically for wide images unless
                you force portrait or landscape, which is the right choice for printing. <strong>Fit to image</strong> instead sizes each page to the
